...
<div id="sub_container">
    <h4 class="grey-text">ClipbucketV5 is an open-source software under <a href="https://opensource.org/license/gpl-3-0" target="_blank" class="grey-text" style="text-decoration:underline;">GNU General Public License version 3</a>.</h4>
    ...
    <br/>
    <h4 class="grey-text">Clipbucket was originally an open-source software under <a href="https://opensource.org/license/attribution-php" target="_blank" class="grey-text" style="text-decoration:underline;">Attribution assurance license</a>.</h4>
    <div class="small" style="margin-bottom:5px;">
        Because Clipbucket original is dead since 2018 <a href="https://github.com/arslancb/clipbucket" target="_blank" style="text-decoration:none; color:#333;"><i>(officially since 2022)</i></a>, branding removal license can't be bought anymore.<br/>
    </div>
    <div class="cb-instal-licenc-holder">
        <div class="cb-instal-licenc-sec">
            <?php echo System::get_license('LICENSE-CB'); ?>
        </div>
    </div>
