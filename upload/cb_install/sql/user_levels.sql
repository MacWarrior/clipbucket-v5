INSERT INTO `{tbl_prefix}user_levels` (`user_level_id`, `user_level_active`, `user_level_name`, `user_level_is_default`, `default_homepage`) VALUES
(1, 'yes', 'Administrator', 'yes', 'homepage'),
(2, 'yes', 'Registered User', 'yes', 'homepage'),
(3, 'yes', 'Inactive User', 'yes', 'homepage'),
(4, 'yes', 'Guest', 'yes', 'homepage'),
(5, 'yes', 'Global Moderator', 'yes', 'homepage'),
(6, 'no', 'Anonymous', 'yes', 'homepage');

INSERT INTO `{tbl_prefix}user_levels_permissions` (`user_level_permission_id`, `user_level_id`, `admin_access`, `allow_video_upload`, `view_video`, `view_photos`, `view_collections`, `view_channel`, `view_videos`, `avatar_upload`, `video_moderation`, `member_moderation`, `ad_manager_access`, `manage_template_access`, `group_moderation`, `web_config_access`, `view_channels`, `playlist_access`, `allow_channel_bg`, `private_msg_access`, `edit_video`, `download_video`, `admin_del_access`, `photos_moderation`, `collection_moderation`, `plugins_moderation`, `tool_box`, `plugins_perms`, `allow_manage_user_level`, `allow_create_collection`, `allow_create_playlist`, `enable_channel_page`, `allow_photo_upload`, `allow_public_video_page`, `default_homepage`) VALUES
(1, 1, 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', '', 'yes', 'yes', 'yes','yes','yes','no', 'homepage'),
(2, 2, 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', '', 'no', 'yes', 'yes','yes','yes','no', 'homepage'),
(3, 3, 'no', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', '', 'no', 'yes', 'yes','yes','yes','no', 'homepage'),
(4, 4, 'no', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'yes', 'no', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', '', 'no', 'no', 'no','no','no','no', 'homepage'),
(5, 5, 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'yes', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 'no', 'no', 'no', '', 'no', 'yes', 'yes','yes','yes','no', 'homepage'),
(6, 6, 'no', 'yes', 'no', 'yes', 'yes', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'no', 'yes', 'no', 'no', 'yes', 'no', 'no', 'no', 'no', 'no', '', 'no', 'yes', 'yes','yes','yes','no', 'homepage');
