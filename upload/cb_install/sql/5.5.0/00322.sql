...
SET @language_key = 'option_enable_sitemap' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Enable sitemap', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Activer le sitemap', @language_id_fra);
