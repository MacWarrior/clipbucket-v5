...
SET @language_key = 'category_type_unknown' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Unknown category type : %s', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Type de catégorie inconnue : %s', @language_id_fra);
