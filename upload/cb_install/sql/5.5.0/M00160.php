...
class M00160 extends Migration
{
    ...
    {
        $sql = 'CREATE TABLE `{tbl_prefix}languages_keys`(
        ...
        $sql = 'CREATE TABLE `{tbl_prefix}languages_translations`(
