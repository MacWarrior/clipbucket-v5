...
SET @language_key = 'completed' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Completed', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Terminé', @language_id_fra);
