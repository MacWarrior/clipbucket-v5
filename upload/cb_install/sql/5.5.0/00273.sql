...
SET @language_key = 'photo_is' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Photo is %s', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'La photo est %s', @language_id_fra);
