INSERT IGNORE INTO `{tbl_prefix}config` (`name`, `value`) VALUES ('tmdb_enable_on_front_end', 'no');
...
SET @language_key = 'tmdb_enable_on_front' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Enable TMDB on front end', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Activer TMDB sur le front office', @language_id_fra);
