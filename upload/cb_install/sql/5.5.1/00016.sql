...
SET @language_key = 'only_keep_max_resolution' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Only keep max resolution', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Conserver uniquement la résolution maximale', @language_id_fra);
