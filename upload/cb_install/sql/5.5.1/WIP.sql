...
SET @language_key = 'enable_on_front' COLLATE utf8mb4_unicode_520_ci;
...
VALUES (@id_language_key, 'Enable on front end', @language_id_eng);
INSERT IGNORE INTO `{tbl_prefix}languages_translations` (`id_language_key`, `translation`, `language_id`)
VALUES (@id_language_key, 'Activer sur le front office', @language_id_fra);
