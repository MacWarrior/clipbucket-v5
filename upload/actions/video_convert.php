...
if (!empty($_filename)) {
    ...
    if (stristr(PHP_OS, 'WIN')) {
        exec(System::get_binaries('php') . ' -q ' . DirPath::get('actions') . 'verify_converted_videos.php ' . $queue_details['cqueue_name']);
    } elseif (stristr(PHP_OS, 'darwin')) {
        exec(System::get_binaries('php') . ' -q ' . DirPath::get('actions') . 'verify_converted_videos.php ' . $queue_details['cqueue_name'] . ' </dev/null >/dev/null &');
    } else {
        exec(System::get_binaries('php') . ' -q ' . DirPath::get('actions') . 'verify_converted_videos.php ' . $queue_details['cqueue_name'] . ' &> /dev/null &');
    }
