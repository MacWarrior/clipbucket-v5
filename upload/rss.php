...
switch ($mode) {
    case 'recent':
    default:
        $videos = get_videos(['limit' => $limit, 'broadcast' => 'public', 'order' => 'date_added DESC']);
        $title = "Recently Added Videos";
        break;

    case 'views':
        $videos = get_videos(['limit' => $limit, 'broadcast' => 'public', 'order' => 'views DESC']);
        $title = "Most Viewed Videos";
        break;

    case 'rating':
        $videos = get_videos(['limit' => $limit, 'broadcast' => 'public', 'order' => 'rating DESC']);
        $title = "Top Rated Videos";
        break;

    case 'watching':
        $videos = get_videos(['limit' => $limit, 'broadcast' => 'public', 'order' => 'last_viewed DESC']);
    ...
    case 'user':
        ...
        $total_vids = get_videos(['count_only' => true, 'user' => $uid]);
