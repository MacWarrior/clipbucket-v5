...
/* $Id: Template_Compiler.class.php 5 2009-08-27 15:01:32Z fwhite $ */
...
class Smarty_Compiler extends Smarty
{
    ...
    function _compile_compiler_tag($tag_command, $tag_args, &$output)
    {
         ...
         */
            ...
            if ($plugin_file = $this->_get_plugin_filepath('compiler', $tag_command)) {
                $found = true;
    ...
    function _compile_block_tag($tag_command, $tag_args, $tag_modifier, &$output)
    {
         ...
         */
            ...
            if ($plugin_file = $this->_get_plugin_filepath('block', $tag_command)) {
                $found = true;
    ...
    function _compile_capture_tag($start, $tag_args = '')
    {
        ...
        if ($start) {
            ...
            $output = "<?php ob_start(); ?>";
            $this->_capture_stack[] = [$buffer, $assign];
        } else {
