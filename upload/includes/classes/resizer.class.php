...
class CB_Resizer
{
                ...
                if (($width > 0 && $height == 0) && $this->cropping == 10) {
                    ...
                    if ($width > 0 && $height == 0) {
                        ...
                        if ($width == 0 && $height > 0) {
                            ...
                            if ($width > 0 && $height > 0 && $this->exact_dimensions == true) {
    ...
    function _create_canvas($width, $height, $background = null)
    {
        ...
        if ($this->target_extension == 'png' && $background == -1) {
            ...
            if ($this->target_extension == 'gif' && $this->gif_transparent_index >= 0 && $background == -1) {
    ...
    function _rotate($angle, $background = null, $resource = null)
    {
        ...
        if ($this->_check_resource($resource)) {
            ...
            if ($this->source_type == IMAGETYPE_PNG && $background == -1) {
                ...
                if ($this->source_type == IMAGETYPE_GIF && $this->gif_transparent_index >= 0) {
    ...
    function _setup_filters()
    {
        ...
        (
            ...
            $this->filters = [
                ...
                3  => [IMG_FILTER_BRIGHTNESS, 1], // level,+/-
                4  => [IMG_FILTER_CONTRAST, 1], // level,+/-
                5  => [IMG_FILTER_COLORIZE, 4], // r-g-b-a
