...
class CronSchedule
{
    ...
    public    $_minutes            = array();
    public    $_hours                = array();
    public    $_daysOfMonth        = array();
    public    $_months            = array();
    public    $_daysOfWeek        = array();
    public    $_years                = array();

    // The original cron specification in compiled form.
    public $_cronMinutes        = array();
    public $_cronHours            = array();
    public $_cronDaysOfMonth    = array();
    public $_cronMonths        = array();
    public $_cronDaysOfWeek    = array();
    public $_cronYears            = array();
     ...
     */
    final public function cronInterpret($specification, $rangeMin, $rangeMax, $namedItems, $errorName)
    {
    ...
    final public function cronCreateItems($cronInterpreted)
    {
        $items = array();
    ...
    final public function dtFromParameters($time = FALSE)
    {
        if($time === FALSE)
        {
            $arrTime = getDate();
    ...
    final public function dtAsString($arrDt)
    {
        if($arrDt === FALSE)
            return FALSE;
    ...
    final public function advanceItem($arrItems, $rangeMin, $rangeMax, & $current)
    {
    ...
    final public function getEarliestItem($arrItems, $afterItem = FALSE, $allowOverflow = TRUE)
    {
    ...
    final public function recedeItem($arrItems, $rangeMin, $rangeMax, & $current)
    {
    ...
    final public function getLatestItem($arrItems, $beforeItem = FALSE, $allowOverflow = TRUE)
    {
    ...
    final public function getClass($spec)
    {
    ...
    final public function classIsSpecified($spec)
    {
    ...
    final public function classIsSingleFixed($spec)
    {
        return (count($spec['elements']) == 1) && (!$spec['elements'][0]['hasInterval']);
    }

    final public function initLang($language = 'en')
    {
        switch($language)
        {
            case 'fr':
                $this->_lang['elemMin: at_the_hour']                            = 'à l\'heure pile';
                $this->_lang['elemMin: after_the_hour_every_X_minute']            = 'toutes les minutes';
                $this->_lang['elemMin: after_the_hour_every_X_minute_plural']    = 'à @1 minutes pile';
                $this->_lang['elemMin: every_consecutive_minute']                = 'chaque minute';
                $this->_lang['elemMin: every_consecutive_minute_plural']        = 'toutes les @1 minutes';
                ...
                $this->_lang['elemHour: past_X:00']                                = 'de @1:00';
                $this->_lang['elemHour: between_X:00_and_Y:59']                    = 'entre @1:00 et @2:59';
                $this->_lang['elemHour: in_the_60_minutes_past_']                = 'dans les 60 minutes après chaque heure';
                $this->_lang['elemHour: in_the_60_minutes_past__plural']        = 'dans les 60 minutes après toutes les @1 heures';
                $this->_lang['elemHour: past_every_consecutive_']                = 'de chaque heures';
                $this->_lang['elemHour: past_every_consecutive__plural']        = 'après toutes les @1 heures';
                $this->_lang['elemHour: past_every_hour']                        = 'de chaque heures';
                $this->_lang['elemDOM: the_X']                                    = 'le @1';
                $this->_lang['elemDOM: every_consecutive_day']                    = 'tous les jours';
                $this->_lang['elemDOM: every_consecutive_day_plural']            = 'tous les jours @1';
                $this->_lang['elemDOM: on_every_day']                            = 'tous les jours';
                $this->_lang['elemDOM: between_the_Xth_and_Yth']                = 'entre le @1 et le @2';
                $this->_lang['elemDOM: on_the_X']                                = 'le @1 jour';
                $this->_lang['elemDOM: on_X']                                    = '@1 jour';
                $this->_lang['elemMonth: every_X']                                = '@1';
                $this->_lang['elemMonth: every_consecutive_month']                = 'chaque mois';
                $this->_lang['elemMonth: every_consecutive_month_plural']        = 'tous les @1 mois';
                $this->_lang['elemMonth: between_X_and_Y']                        = 'du @1 au @2';
                $this->_lang['elemMonth: of_every_month']                        = 'de chaque mois';
                $this->_lang['elemMonth: during_every_X']                        = 'en @1';
                $this->_lang['elemMonth: during_X']                                = 'en @1';
                $this->_lang['elemYear: in_X']                                    = 'dans @1';
                $this->_lang['elemYear: every_consecutive_year']                = 'chaque année';
                $this->_lang['elemYear: every_consecutive_year_plural']            = 'tous les @1 ans';
                ...
                $this->_lang['day: 0_plural']                                    = 'Dimanche';
                $this->_lang['day: 1_plural']                                    = 'Lundi';
                $this->_lang['day: 2_plural']                                    = 'Mardi';
                $this->_lang['day: 3_plural']                                    = 'Mercredi';
                $this->_lang['day: 4_plural']                                    = 'Jeudi';
                $this->_lang['day: 5_plural']                                    = 'Vendredi';
                $this->_lang['day: 6_plural']                                    = 'Samedi';
                $this->_lang['month: 1']                                        = 'Janvier';
                $this->_lang['month: 2']                                        = 'Fevrier';
                $this->_lang['month: 3']                                        = 'Mars';
                $this->_lang['month: 4']                                        = 'Avril';
                $this->_lang['month: 5']                                        = 'Mai';
                $this->_lang['month: 6']                                        = 'Juin';
                $this->_lang['month: 7']                                        = 'Juillet';
                $this->_lang['month: 8']                                        = 'Aout';
                ...
                $this->_lang['ordinal: 2']                                        = '2ieme';
                $this->_lang['ordinal: 3']                                        = '3ieme';
                $this->_lang['ordinal: 4']                                        = '4ieme';
                $this->_lang['ordinal: 5']                                        = '5ieme';
                $this->_lang['ordinal: 6']                                        = '6ieme';
                $this->_lang['ordinal: 7']                                        = '7ieme';
                $this->_lang['ordinal: 8']                                        = '8ieme';
                $this->_lang['ordinal: 9']                                        = '9ieme';
                $this->_lang['ordinal: 10']                                        = '10ieme';
                $this->_lang['ordinal: 11']                                        = '11ieme';
                $this->_lang['ordinal: 12']                                        = '12ieme';
                $this->_lang['ordinal: 13']                                        = '13ieme';
                $this->_lang['ordinal: 14']                                        = '14ieme';
                $this->_lang['ordinal: 15']                                        = '15ieme';
                $this->_lang['ordinal: 16']                                        = '16ieme';
                $this->_lang['ordinal: 17']                                        = '17ieme';
                $this->_lang['ordinal: 18']                                        = '18ieme';
                $this->_lang['ordinal: 19']                                        = '19ieme';
                $this->_lang['ordinal: 20']                                        = '20ieme';
                $this->_lang['ordinal: 21']                                        = '21ieme';
                $this->_lang['ordinal: 22']                                        = '22ieme';
                $this->_lang['ordinal: 23']                                        = '23ieme';
                $this->_lang['ordinal: 24']                                        = '24ieme';
                $this->_lang['ordinal: 25']                                        = '25ieme';
                $this->_lang['ordinal: 26']                                        = '26ieme';
                $this->_lang['ordinal: 27']                                        = '27ieme';
                $this->_lang['ordinal: 28']                                        = '28ieme';
                $this->_lang['ordinal: 29']                                        = '29ieme';
                $this->_lang['ordinal: 30']                                        = '30ieme';
                $this->_lang['ordinal: 31']                                        = '31ieme';
                $this->_lang['ordinal: 32']                                        = '32ieme';
                $this->_lang['ordinal: 33']                                        = '33ieme';
                $this->_lang['ordinal: 34']                                        = '34ieme';
                $this->_lang['ordinal: 35']                                        = '35ieme';
                $this->_lang['ordinal: 36']                                        = '36ieme';
                $this->_lang['ordinal: 37']                                        = '37ieme';
                $this->_lang['ordinal: 38']                                        = '38ieme';
                $this->_lang['ordinal: 39']                                        = '39ieme';
                $this->_lang['ordinal: 40']                                        = '40ieme';
                $this->_lang['ordinal: 41']                                        = '41ieme';
                $this->_lang['ordinal: 42']                                        = '42ieme';
                $this->_lang['ordinal: 43']                                        = '43ieme';
                $this->_lang['ordinal: 44']                                        = '44ieme';
                $this->_lang['ordinal: 45']                                        = '45ieme';
                $this->_lang['ordinal: 46']                                        = '46ieme';
                $this->_lang['ordinal: 47']                                        = '47ieme';
                $this->_lang['ordinal: 48']                                        = '48ieme';
                $this->_lang['ordinal: 49']                                        = '49ieme';
                $this->_lang['ordinal: 50']                                        = '50ieme';
                $this->_lang['ordinal: 51']                                        = '51ieme';
                $this->_lang['ordinal: 52']                                        = '52ieme';
                $this->_lang['ordinal: 53']                                        = '53ieme';
                $this->_lang['ordinal: 54']                                        = '54ieme';
                $this->_lang['ordinal: 55']                                        = '55ieme';
                $this->_lang['ordinal: 56']                                        = '56ieme';
                $this->_lang['ordinal: 57']                                        = '57ieme';
                $this->_lang['ordinal: 58']                                        = '58ieme';
                $this->_lang['ordinal: 59']                                        = '59ieme';
                break;
    ...
    final public function natlangPad2($number)
    {
        return (strlen($number) == 1 ? '0' : '').$number;
    }

    final public function natlangApply($id, $p1 = FALSE, $p2 = FALSE, $p3 = FALSE, $p4 = FALSE, $p5 = FALSE, $p6 = FALSE)
    {
        $txt = $this->_lang[$id];
    ...
    final public function natlangRange($spec, $entryFunction, $p1 = FALSE)
    {
        $arrIntervals = array();
    ...
    final public function natlangElementMinute($elem)
    {
        if(!$elem['hasInterval'])
        {
    ...
    final public function natlangElementHour($elem, $asBetween)
    {
        if(!$elem['hasInterval'])
        {
    ...
    final public function natlangElementDayOfMonth($elem)
    {
        if(!$elem['hasInterval'])
    ...
    final public function natlangElementMonth($elem)
    {
        if(!$elem['hasInterval'])
    ...
    final public function natlangElementYear($elem)
    {
        if(!$elem['hasInterval'])
            return $elem['number1'];
