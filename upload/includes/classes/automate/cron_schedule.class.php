    ...
    final public function initLang($language = 'en')
    {
        switch($language)
        {
            case 'fr':
                ...
                $this->_lang['elemMin: every_consecutive_minute']                = 'chaque consecutive minute';
                $this->_lang['elemMin: every_consecutive_minute_plural']        = 'toutes les @1 minutes consecutive';
                ...
                $this->_lang['elemHour: past_X:00']                                = 'passé @1:00';
                $this->_lang['elemHour: between_X:00_and_Y:59']                    = 'entre @1:00 et @2:59';
                $this->_lang['elemHour: in_the_60_minutes_past_']                = 'dans les 60 minutes passées chaque heure consécutive';
                $this->_lang['elemHour: in_the_60_minutes_past__plural']        = 'dans les 60 minutes passées toutes les @1 heures consécutives';
                $this->_lang['elemHour: past_every_consecutive_']                = 'passé toutes les heures consécutives';
                $this->_lang['elemHour: past_every_consecutive__plural']        = 'passé toutes les @1 heures consécutives';
                $this->_lang['elemHour: past_every_hour']                        = 'passé toutes les heures';
                $this->_lang['elemDOM: the_X']                                    = 'le @1';
                $this->_lang['elemDOM: every_consecutive_day']                    = 'tous les jours consécutifs';
                $this->_lang['elemDOM: every_consecutive_day_plural']            = 'tous les jours @1 consécutifs';
                ...
                $this->_lang['elemDOM: on_X']                                    = 'sur @1';
                $this->_lang['elemMonth: every_X']                                = 'chaque @1';
                $this->_lang['elemMonth: every_consecutive_month']                = 'chaque mois consécutif';
                ...
                $this->_lang['elemMonth: during_every_X']                        = 'de @1';
                $this->_lang['elemMonth: during_X']                                = 'de @1';
