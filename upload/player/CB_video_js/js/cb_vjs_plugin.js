...
cbvjsheader.prototype.init = function(){
	...
	CbVjsHeader.innerHTML = "<div class='captionBlock'><div class='vidTitle col'><a target='_blank' href='"+"/watch_video.php?v="+cbvjsheader.videoid+"'>"+cbvjsheader.title+"</a></div><div class='uploaderName col'>par "+cbvjsheader.uploader+"</div></div>";
