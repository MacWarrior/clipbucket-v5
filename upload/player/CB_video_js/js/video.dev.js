...
/**
 * Clipbucket default logo and can be replaced by using branding plugin 
 * TODO - Future make it click to open the product
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
 */
vjs.CbBrndrm = vjs.Button.extend({
  init: function(player, options){
    this.show_logo = player.options().show_logo;
    this.branding_logo = player.options().branding_logo;
    this.product_link = player.options().product_link;
    vjs.Button.call(this, player, options);
  }
});
...
vjs.CbBrndrm.prototype.onClick = function(){
  window.open(this.product_link, '_blank');
};
/**
...
================================================================================ */
/**
 * Palyer Cation. Shows the Video title and uploader name.
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @class
 * @constructor
...
vjs.CbplayerCaption = vjs.Component.extend({
  init: function(player,options){
    this.videotitle = player.options().videotitle;
    this.uploader = player.options().uploader;
    vjs.Component.call(this, player, options);
  }
});

vjs.CbplayerCaption.prototype.createEl = function(){
  return vjs.Component.prototype.createEl.call(this, 'div', {
    className: 'vjs-cb-player-caption',
    innerHTML: '<span aria-hidden="" class="video-title">'+this.videotitle+'</span><span aria-hidden="" class="uploader"> Uploaded By '+this.uploader+' </span>',
    'aria-label': 'caption'
  });
};
/**
