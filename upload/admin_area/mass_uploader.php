...
if (!Update::IsCurrentDBVersionIsHigherOrEqualTo('5.5.2', '148')) {
    sessionMessageHandler::add_message('Sorry, you cannot upload new videos until the application has been fully updated by an administrator', 'e', DirPath::getUrl('admin_area'));
}
