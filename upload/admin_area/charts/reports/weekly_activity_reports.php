...
//Videos
$videos['uploads'] = $cbvid->get_videos(["count_only" => true, "date_span" => "this_week"], true);
$videos['processing'] = $cbvid->get_videos(["count_only" => true, "status" => "Processing", "date_span" => "this_week"], true);
$videos['active'] = $cbvid->get_videos(["count_only" => true, "active" => "yes", "date_span" => "this_week"], true);
...
//Users
$users['signups'] = $userquery->get_users(["count_only" => true, "date_span" => "this_week"]);
$users['inactive'] = $userquery->get_users(["count_only" => true, "date_span" => "this_week", "status" => 'ToActivate']);
$users['active'] = $userquery->get_users(["count_only" => true, "date_span" => "this_week", "status" => 'Ok']);
