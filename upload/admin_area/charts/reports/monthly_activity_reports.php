...
//Videos
$videos['uploads'] = CBvideo::getInstance()->get_videos(['count_only' => true, 'date_span' => 'this_month'], true);
$videos['processing'] = CBvideo::getInstance()->get_videos(['count_only' => true, 'status' => 'Processing', 'date_span' => 'this_month'], true);
$videos['active'] = CBvideo::getInstance()->get_videos(['count_only' => true, 'active' => 'yes', 'date_span' => 'this_month'], true);
...
//Users
$users['signups'] = userquery::getInstance()->get_users(['count_only' => true, 'date_span' => 'this_month']);
$users['inactive'] = userquery::getInstance()->get_users(['count_only' => true, 'date_span' => 'this_month', 'status' => 'ToActivate']);
$users['active'] = userquery::getInstance()->get_users(['count_only' => true, 'date_span' => 'this_month', 'status' => 'Ok']);
