<html>
    <head>
        ...
        <title>Website is under technical maintenance</title>
        <link rel="stylesheet" href="./styles/cb_28/theme/css/all.min.css">
    ...
    <div style="overflow:hidden;background:url('./styles/cb_28/theme/images/clouds.jpg') 0% 0% / 100% no-repeat rgb(247, 249, 251);height:100%;" class="page-error">
        ...
        <img src="./styles/cb_28/theme/images/base.png" alt="background" class="base-bg"/>
    </div>
    </body>
</html>