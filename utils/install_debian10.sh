...
apt install php7.3 apache2 mariadb-server git php-curl php-imagick ffmpeg gpac php7.3-mysql php7.3-xml php7.3-mbstring sendmail mediainfo lshw --yes > /dev/null 2>&1
echo -ne " OK"
