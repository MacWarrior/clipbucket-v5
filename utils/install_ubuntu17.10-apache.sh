#!/bin/bash
# ClipbucketV5 install on Ubuntu 17.10.1
...
apt-get install php7.1 apache2 mariadb-server php-curl ffmpeg php7.1-mysql php7.1-xml php7.1-mbstring php7.1-gd sendmail mediainfo --yes > /dev/null 2>&1
sed -i "s/upload_max_filesize = 2M/upload_max_filesize = 100M/g" /etc/php/7.1/apache2/php.ini
sed -i "s/post_max_size = 8M/post_max_size = 100M/g" /etc/php/7.1/apache2/php.ini
