...
apt-get install php7.0 apache2 libapache2-mod-php mariadb-server php-curl php-imagick ffmpeg gpac ruby php7.0-mysql php7.0-xml php7.0-mbstring sendmail mediainfo --yes > /dev/null 2>&1
