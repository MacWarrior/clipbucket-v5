...
echo 			rewrite ^^/videos/(.*)/(.*)/(.*)/(.*) /videos.php?cat=$1^&sort=$2^&time=$3^&page=$4 last;>> %NGINX_CONF%
echo 			rewrite ^^/videos/(.*)/(.*)/(.*) /videos.php?sort=$1^&time=$2^&page=$3 last;>> %NGINX_CONF%
...
echo 			rewrite ^^/channels/(.*)/(.*)/(.*)/(.*) /channels.php?cat=$1^&sort=$2^&time=$3^&page=$4 last;>> %NGINX_CONF%
echo 			rewrite ^^/channels/(.*)/(.*)/(.*) /channels.php?sort=$1^&time=$2^&page=$3 last;>> %NGINX_CONF%
...
echo 			rewrite ^^/collections/(.*)/(.*)/(.*)/(.*) /collections.php?cat=$1^&sort=$2^&time=$3^&page=$4 last;>> %NGINX_CONF%
echo 			rewrite ^^/collections/(.*)/(.*)/(.*) /collections.php?sort=$1^&time=$2^&page=$3 last;>> %NGINX_CONF%
...
echo 			rewrite ^^/photos/(.*)/(.*)/(.*)/(.*) /photos.php?cat=$1^&sort=$2^&time=$3^&page=$4 last;>> %NGINX_CONF%
echo 			rewrite ^^/photos/(.*)/(.*)/(.*) /photos.php?sort=$1^&time=$2^&page=$3 last;>> %NGINX_CONF%
