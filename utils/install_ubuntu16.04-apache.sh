...
apt-get install php7.0 apache2 libapache2-mod-php mariadb-server php-curl ffmpeg php7.0-mysql php7.0-xml php7.0-mbstring php7.0-gd sendmail mediainfo lshw --yes > /dev/null 2>&1
