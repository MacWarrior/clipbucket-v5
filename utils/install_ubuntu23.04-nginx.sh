#!/bin/bash
# ClipbucketV5 install on Ubuntu 23.04
...
apt install php8.1-fpm nginx-full mariadb-server git php8.1-curl ffmpeg php8.1-mysqli php8.1-xml php8.1-mbstring php8.1-gd sendmail mediainfo --yes > /dev/null 2>&1
...
server {
    ...
    root /srv/www/clipbucket/upload/;
    index index.php;
