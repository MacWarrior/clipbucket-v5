#!/bin/bash
# Clipbucket install on Debian 11
...
apt install php7.4-fpm nginx-full mariadb-server git php7.4-curl ffmpeg php7.4-mysqli php7.4-xml php7.4-mbstring php7.4-gd sendmail mediainfo lshw --yes > /dev/null 2>&1
