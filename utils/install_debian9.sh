...
apt-get install php7.0 apache2 mariadb-server git php-curl php-imagick ffmpeg gpac php7.0-mysqli php7.0-xml php7.0-mbstring sendmail mediainfo --yes > /dev/null 2>&1
echo -ne " OK"
